...
public class TestBase {
	...
	public void setUp() {
		...
		if (driver == null) {
			...
			PropertyConfigurator.configure("./src/test/resources/properties/log4j.properties");//configure with log4j property file
			...
			if(System.getenv("browser")!=null && !System.getenv("browser").isEmpty()){
				...
				browser = System.getenv("browser");    // here use jenkins variables
			}else{
				
				browser = config.getProperty("browser");    // here use properties 
